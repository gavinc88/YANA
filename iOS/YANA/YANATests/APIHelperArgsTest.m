...
@interface APIHelperArgsTest : XCTestCase

@end

@implementation APIHelperArgsTest
...
- (void)testGetArgsForActionGetNearbyUsersDefault{
    NSData *args = [apiHelper getArgsForActionGetNearbyUsers:@"user_id"
